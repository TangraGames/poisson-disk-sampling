 ...
 *************************************************************************/
 ...
 // the rand function from the Macroquad library has cross platform support (e.g. web)
...
#[allow(dead_code)]
// This function is not used in this example but it is useful for debugging
